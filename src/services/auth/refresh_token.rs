...
use crate::{
    ...
    }, app_state::AppState, persistence::user::{find_user_by_id, Model}, security::Claims, util::{create_token_from_user, require_some}
};
...
pub async fn refresh_token(
    ...
    let claims = require_some(input.claims, || "Claims are empty".to_string(), StatusCode::INSUFFICIENT_STORAGE)?;
